...
export const getTreatmentAreasAccordion = (t: (key: string) => string) => [
  {
    id: 'frownLines',
  ...
  },
  {
    ...
    content: (
      <>
        <P>{t('hudochinjektioner.treatmentAreas.accordion.forehead.text1')}</P>
  ...
  },
  {
    ...
    content: (
      <>
        <P>{t('hudochinjektioner.treatmentAreas.accordion.crowFeet.text1')}</P>
